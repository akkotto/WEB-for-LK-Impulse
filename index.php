...
<div class="wrapper">
	...
	<form action="javascript:void(null);" method="POST" id="formbuy" onsubmit="formbuy();">
		...
		<input type="text" name="steamid" class="inputtext" placeholder="Ваш steamid (Пример: STEAM:0:1:53615624)" <?php if(isset($_SESSION['steamid'])) echo 'value="'.toSteamID($_SESSION['steamid']).'"'; ?>>
